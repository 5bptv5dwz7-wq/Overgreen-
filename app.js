...
async function generateExtraClosurePdf(e,button){
  ...
  try{
    ...
    const fields=[['LAVORO',e.titolo],['LUOGO',place],['INDIRIZZO',address||'Non indicato'],['DATA',fmt(e.giorno_intervento)],['OPERATORI',names.join(', ')||'Non indicati'],['STATO','Chiuso e convalidato']];
